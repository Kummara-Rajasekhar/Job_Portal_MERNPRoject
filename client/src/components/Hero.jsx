  ...
  return (
    <div className='container 2xl:px-20 mx-auto my-10'>
      <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl'>
        <h2 className='text-2xl md:text-3xl mg:text-4xl font-medium mb-4'>Over 10,000+ jobs to apply</h2>
      ...
      <div className='border vorder-gray-300 shadow-md mx-2 mt-5 p-6 rounded-md flex'>
